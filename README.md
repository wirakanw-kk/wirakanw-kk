...
I'm Kiki. I'm a **Software & AI Systems Engineer** focusing on building computer vision pipelines, generative AI applications, and cloud-connected backends. 
...
| **AI & LLMs** | RAG Architecture, Ollama (Local Llama), LLM-as-a-Judge Evaluation, OpenAI Whisper |
| **Computer Vision** | OpenCV, Segment Anything Model (SAM), YOLO, NumPy, SciPy |
| **Backend & Cloud** | Firebase/Firestore, Firebase Auth (Password Hashing / Security)|
...
* **Focus:** System Architecture, Object-Oriented Design, API integration
* **Tech Stack:** C#, Python, REST API, OOP
* **Key Architecture**
  * C# board controller
  * Python move search
